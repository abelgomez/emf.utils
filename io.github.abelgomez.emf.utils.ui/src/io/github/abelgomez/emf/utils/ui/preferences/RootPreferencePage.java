...
public class RootPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	private static final String CUSTOM_EMF_REGISTRY = "io.github.abelgomez.emf.packageregistry";
	...
	private String buildLinkText() {
		StringBuilder builder = new StringBuilder();
								builder.append("The EMF EPackage custom registry (");
		if (isPdeAvailable())
		...
		if (isPdeAvailable())
								...
								builder.append("io.github.abelgomez.emf.packageregistry");
		if (isPdeAvailable())
								builder.append("</a>");

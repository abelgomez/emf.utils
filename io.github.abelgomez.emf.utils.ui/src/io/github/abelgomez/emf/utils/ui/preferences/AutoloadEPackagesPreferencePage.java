package io.github.abelgomez.emf.utils.ui.preferences;
...
import io.github.abelgomez.emf.utils.dynregistry.provider.DynregistryItemProviderAdapterFactory;
...
public class AutoloadEPackagesPreferencePage
	...
	public AutoloadEPackagesPreferencePage() {
		super();
		setPreferenceStore(EMFUtilsUiPlugin.getDefault().getPreferenceStore());
		setDescription("Manage which resources containing an Ecore EPackage should be auto-loaded");
		registryManager = EMFUtilsPlugin.getDefault().getRegistryManager();
	}

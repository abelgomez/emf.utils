/**
 */
package fr.inria.atlanmod.emf.utils.dynregistry.util;
...
public class DynregistryAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link fr.inria.atlanmod.emf.utils.dynregistry.Registry <em>Registry</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link fr.inria.atlanmod.emf.utils.dynregistry.RegistryEntry <em>Registry Entry</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
